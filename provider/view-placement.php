...
$id = (int)($_GET['id'] ?? 0);
if (!$id || !$companyId) { header('Location: requests.php'); exit; }
...
$p = $stmt->fetch();
if (!$p) { header('Location: requests.php'); exit; }
...
<div class="main">
    ...
    <div class="page-content">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1.5rem;flex-wrap:wrap;gap:1rem;">
            <a href="requests.php" class="btn btn-ghost btn-sm">← Back to Requests</a>
        </div>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;">
            ...
            <!-- Provider Feedback -->
            <?php if ($p['provider_feedback']): ?>
            <div class="panel" style="grid-column:1/-1;">
                <div class="panel-header"><h3>Your Feedback</h3></div>
                <div style="padding:1.25rem;color:var(--text);font-size:0.9375rem;line-height:1.7;white-space:pre-wrap;">
                    <?= htmlspecialchars($p['provider_feedback']) ?>
                </div>
            </div>
            <?php endif; ?>
